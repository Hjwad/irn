...
@Client.on_message(filters.command(["playlist","لیستی گۆرانی","لیستی گورانی","لیستی پەخشکردن"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & ~BANNED_USERS)
@language
...
@Client.on_message(filters.command(["delplaylist", "سڕینەوەی لیست","deleteplaylist"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & ~BANNED_USERS)
@language
